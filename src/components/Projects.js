...
export default function Projects() {
    const projectdescriptions = [
        ...
        {name: 'Battle for LA', link: "https://kylephan5.github.io", pic: battleforla, blurb:"Built a 2D arcade basketball single player game where the user controls the LA Clippers and the enemy is the Lakers, used JavaScript for front-end/back-end development", date:"Aug 2022", techstack:"JavaScript, HTML", sourcecode:"https://github.com/kylephan5/kylephan5.github.io"},
