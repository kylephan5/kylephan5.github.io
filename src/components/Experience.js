...
export default function Experience() {
    const experience = [
        {company: 'iCapital Network', position: 'Software Engineering Intern', blurb: 'Building a full stack internal tool that streamlines Rake task management for product managers, using React and Ruby on Rails, Designing RESTful API endpoints and testing them with Postman API, managing state with Redux, and writing RSpec unit tests to ensure validity of backend code, Writing Rake tasks to configure permissions and ensure that access to the tool is restricted to specific users, collaborating with product managers on interface wireframe', picture: icapital, date:'June 2023 - Aug 2023', img_tag: 'icapital'},
