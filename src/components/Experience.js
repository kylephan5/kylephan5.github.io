...
export default function Experience() {
    const experience = [
        {company: 'iCapital Network', position: 'Platform Engineering Intern', blurb: 'Incoming intern working with the Platform Engineering team at iCapital, using Ruby on Rails for backend development and React.js for frontend development', picture: icapital, date:'June 2023 - Aug 2023', img_tag: 'icapital'},
